    ...
    return (
        <nav className={`fixed w-full left-0 top-0 z-[999] ${sticky ? "bg-white/60 text-gray-900" : "text-white" }`}>
            <div className="flex items-center justify-end">
                {/* <div className="mx-7">
                    <h4 className="text-4xl uppercase font-bold">K p</h4>
                </div> */}
                ...
                <div className={`md:hidden text-gray-900 absolute w-2/3 h-screen px-7 py-2 font-medium top-0 bg-white duration-300 ${open?'right-0':'right-[-100%]'}`}>
