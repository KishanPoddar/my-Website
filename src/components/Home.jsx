        ...
        <section id="home" className="min-h-screen flex justify-center items-center py-10">
            <div className="mt-11">
                <div className="lg:text-left text-center">
                    ...
                    <h4 className="lg:text-2xl sm:text-xl text-sm text-base lg:leading-normal leading-5 mt-2 font-bold text-gray-600">Game Developer | Full Stack Developer | Coder</h4>
